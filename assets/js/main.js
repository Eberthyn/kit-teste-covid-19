...
/*Troca rodapé ao redimensionar tela*/
$(window).on('resize', function () {
  var tam = $(window).width();
  if (tam <= 980) {
    $("#rodape1").attr("src", "assets/images/rodape/img1.png").css("max-width", "60%");
    $("#rodape2").attr("src", "assets/images/rodape/img2.png").css("max-width", "60%");
  } else {
    $("#rodape1").attr("src", "");
    $("#rodape2").attr("src", "assets/images/rodape/img3.png").css("max-width", "100%");
  }
});
